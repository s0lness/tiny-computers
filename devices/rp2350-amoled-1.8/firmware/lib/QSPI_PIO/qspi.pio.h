...
static __pio_const uint16_t qspi_4wire_data_program_instructions[] = {
            //     .wrap_target
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program qspi_4wire_data_program = {
...
static __pio_const uint16_t qspi_1write_cmd_program_instructions[] = {
            //     .wrap_target
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program qspi_1write_cmd_program = {
