...
const PALETTE_CELL_GAP_PX = 16; // sketch.c PALETTE_CELL_GAP_PX - sixth round: was 8, widened so the pop's own overshoot cannot collide two neighbours (see sketch.c's own _Static_assert)
